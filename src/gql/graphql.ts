...
/** Autogenerated input type of DeleteDislike */
export type DeleteDislikeInput = {
...
/** Autogenerated return type of DeleteDislike. */
export type DeleteDislikePayload = {
  __typename?: 'DeleteDislikePayload';
  /** A unique identifier for the client performing the mutation. */
...
export type Mutation = {
  ...
  createUser: User;
  /** 苦手ネタ削除 */
  deleteDislike?: Maybe<DeleteDislikePayload>;
};
...
export type DeleteDislikeMutation = { __typename?: 'Mutation', deleteDislike?: { __typename?: 'DeleteDislikePayload', success: boolean } | null };
...
export const AddDislikeDocument = gql`
    mutation addDislike($ingredientId: ID!, $email: String!) {
  createDislike(ingredientId: $ingredientId, email: $email) {
    id
    ingredient {
      id
    }
...
export const DeleteDislikeDocument = gql`
    mutation deleteDislike($ingredientId: ID!, $email: String!) {
  deleteDislike(input: {ingredientId: $ingredientId, email: $email}) {
    success
  }
}
    `;
